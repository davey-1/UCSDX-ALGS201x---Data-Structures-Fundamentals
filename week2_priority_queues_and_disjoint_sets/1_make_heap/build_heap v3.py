...
class MinHeap:
    ...
    def minHeapify(self, pos):
        ...
        if not self.isLeaf(pos):
            ...
            # if self.leftChild(pos) != -1 and  self.rightChild(pos) != -1 and (self.Heap[pos] < self.Heap[self.leftChild(pos)]
            ...
            if l!=-1 and self.Heap[l]<self.Heap[min_index]:
                min_index = l 
            if r != -1 and self.Heap[r] < self.Heap[min_index]:
                min_index = r

            if pos != min_index:
                self.swap(pos, min_index)
